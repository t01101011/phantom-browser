...
/**
 * MCP panel: the one place to connect an AI agent to Phantom Browser and watch what it
    ...
    <div className="flex-1 overflow-auto" style={{ padding: "24px 32px" }}>
      <div className="max-w-[960px] mx-auto">
        ...
        <div className="text-[13px] text-slate-500 mb-5 leading-relaxed max-w-[68ch]">
          ...
          Cline, …) at Phantom Browser, then launch a profile and let the agent open tabs, click, type,
...
function ConnectCard({
  ...
  const llmPrompt = useMemo(
    () =>
      [
        "I'm using Phantom Browser, which runs a local MCP server so an AI agent can drive its browser profiles (open tabs, click, type, read pages).",
        "",
        ...
        "",
        'Once connected, every Phantom Browser tool is prefixed "multizen." — I\'ll launch a profile in Phantom Browser and you can drive it.',
      ].join("\n"),
